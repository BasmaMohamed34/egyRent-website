...
<div className="contain w-100 p-2">
        ...
        <select className="search1 " value={this.state.bedrooms} onChange={this.handleClick}>
            <option  value="" disabled>-------Select bedrooms Number------</option>
        ...
        <select className="search1" value={this.state.beds} onChange={this.handleClick1}>
            <option  value="" disabled>---------Select Beds Number---------</option>
            <option  value="1">1</option>
            <option  value="2">2</option>
            <option  value="3">3</option>
            <option  value="4">4 </option>
        ...
        <input className="search1 search-price" type="text" onKeyUp={this.handlePrice} placeholder="Enter Price..."/>
        <input className="reset btn btn-lg" onClick={this.handleReset} value="Reset"/>
</div>
