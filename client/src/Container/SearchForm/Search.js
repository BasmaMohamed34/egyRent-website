              ...
              <div className="container">
                          <div className="row search-form justify-content-between ">
                              {/* <form className="form-row"> */}
                                  ...
                                  <h5>Location</h5>
                                      <input type="text" className="form-control w-100"  placeholder="Location" value = {this.state.location} onChange={(e)=>{
                                          this.setState({
                                  ...
                                  <div className="col-md-4 col">
                                      <h5>No. of Guests</h5>
                                      <input type="number" className="form-control w-100 m-auto" placeholder="guest number" value = {this.state.guests} onChange={(e)=>{
                                          this.setState({
                                  ...
                                  {/* <Route path={`/search-result/${this.state.location}/${this.state.guests}`}><input value="Search By Location" type="submit" className="searchBtn btn-primary " onClick={()=>{}}/>
                                    ...
                                    <Link to={`/search-result/${this.state.location}/${this.state.guests}`}><button className="btn btn-success mt-3 ">Search By Location</button></Link>
