      ...
      <div class="container">
        <div class="row">
          ...
          <span class="fa fa-group mb-3"></span>
           ...
           <b>Egrent</b> is an online marketplace that connects people who want to rent out their homes with people who are looking for accommodations in that locale. It currently covers more than city in Egypt. 
           <br/><br/>
           <b>For hosts</b>, participating in <b>Egrent</b> is a way to earn some income from their property, but with the risk that the guest might do damage to it. For guests, the advantage can be relatively inexpensive accommodations, but with the risk that the property won’t be as appealing as the listing made it seem.
            </p>
          </div>
          {/* section 2 */}
          <div class="col-lg-4 col-sm-6 col-ex-12 about-item wow lightSpeedIn" data-wow-offset="200">
            ...
            <p className="lead text-light">
              ...
              <b>Egrent</b> hosts list many different kinds of properties single rooms, a suite of rooms, apartments, moored yachts, houseboats, entire houses<br/><br/>
              ...
              <div class="help">
                  <ul className = "type">
                      ...
                      <li>
                          ...
                          <a href="#" className='text-light  ml-1'><b>1-888-922-2336</b></a>
                      </li>
                      <li>
                      ...
                      <li> 
                          ...
                          <a href="#" className='text-light  ml-1'><b>instgram.com</b></a>
                      </li>
                  </ul>
              </div>
          </div> 
